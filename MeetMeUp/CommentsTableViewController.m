...
- (void)viewDidLoad
{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"https://api.meetup.com/2/event_comments?&sign=true&photo-host=public&event_id=%@&page=20&key=202319351e53624c24b661e3f521916",self.event.eventID]];
